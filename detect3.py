...
# Process predictions
belummatang_count, matang_count, bunga_count = 0, 0, 0
for i, det in enumerate(pred):  # per image
    ...
    if len(det):
        ...
        for *xyxy, conf, cls in reversed(det):
            ...
            # Hitung jumlah buah dalam kelas
            if label == "belummatang":
                belummatang_count += 1
        # Second-stage classifier (optional)
        # pred = utils.general.apply_classifier(pred, classifier_model, im, im0s)
...
def parse_opt():
    ...
    parser.add_argument(
        "--source",
        type=str,
        default=ROOT / "./Video/jerukhijau.mp4",
        help="C:\\Users\\fjgsn\\yolov5\\Video\\",
    )
    parser.add_argument(
        "--data",
        type=str,
